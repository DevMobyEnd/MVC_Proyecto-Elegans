                            ...
                            <div class="card-body">
                                <form action="/./Views/login.php" method="POST">
                                    <div class="mb-3">
                                        <section>
                                            <div class="form-group d-flex flex-column align-items-center">
                                                <input type="email" placeholder="Correo Electrónico" class="form-control" name="Gmail" style="width: 100%;">
                                    ...
                                    <div class="mb-3">
                                        <section>
                                            <div class="form-group d-flex flex-column align-items-center">
                                                <input type="password" placeholder="Contraseña" class="form-control" name="password" style="width: 100%;">
                                                <label class="form-label">
