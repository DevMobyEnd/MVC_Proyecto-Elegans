...
<body>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="/Public/dist/js/theme-toggle.js"></script>
    <script src="/Public/dist/js/sidebar.js"></script>
    <script src="/Public/dist/js/Myperfil.js"></script> 
    <script src="/Public/dist/js/register.js" ></script>
    <script src="/Public/dist/js/Cropper.js"></script>
    <!-- <script src="/Public/dist/js/editarperfil.js"></script> -->
    <!-- <script>
        $(".alert").alert();
    </script> -->
</body>
