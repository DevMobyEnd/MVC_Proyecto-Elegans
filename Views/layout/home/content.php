                    ...
                    <div class="card-body p-0">
                        <div class="row g-0">
                            <div class="col-12 col-md-8">
                                <div class="p-3">
                                    <h4><?php echo $userData['isLoggedIn'] ? "¡Bienvenido, <strong>" . htmlspecialchars($_SESSION['apodo']) . "</strong>!" : "Bienvenido a solicitudes bar Elegans!"; ?></h4>
                                    <p><?php echo $userData['isLoggedIn'] ? "¿Listo para hacer tu solicitud de música? ¡Comencemos!" : "Aquí podrás hacer la solicitud de tus canciones favoritas desde la comodidad de tu mesa."; ?></p>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <p><?php echo $userData['isLoggedIn'] ? "¿Qué canción te gustaría escuchar hoy?" : "Recuerda que antes de realizar cualquier solicitud, debes iniciar sesión"; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
